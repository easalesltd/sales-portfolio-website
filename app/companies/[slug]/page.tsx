  ...
  const companyMetadata = {
    'museums-and-galleries': {
      ...
      keywords: [
        ...
        // Angela Harding SEO - Current (Museums & Galleries)
        ...
        'Angela Harding Museums and Galleries',
        'Angela Harding Museums and Galleries cards',
        'Angela Harding Museums and Galleries supplier',
        'Angela Harding Museums and Galleries wholesale',
        'Angela Harding Museums and Galleries sales agent',
        'Angela Harding greeting cards Museums and Galleries',
        'buy Angela Harding greeting cards',
        'Angela Harding cards where to buy',
        'Angela Harding greeting cards supplier UK',
        'Angela Harding wholesale supplier',
        'Angela Harding trade supplier',
        'Angela Harding retailer supplier',
        
        // Angela Harding SEO - Past (Art Angels) - Capture legacy searches
        'Angela Harding Art Angels',
        'Angela Harding Art Angels cards',
        'Angela Harding Art Angels greeting cards',
        'Angela Harding Art Angels supplier',
        'Angela Harding Art Angels wholesale',
        'Angela Harding formerly Art Angels',
        'Angela Harding used to be Art Angels',
        'Angela Harding previously Art Angels',
        'Art Angels Angela Harding',
        'Art Angels Angela Harding cards',
        'Angela Harding greeting cards Art Angels',
        'where did Angela Harding move from',
        'Angela Harding supplier change',
        'Angela Harding new supplier',
        'Angela Harding old supplier',
        'Angela Harding previous supplier',
        'Angela Harding supplier 2024',
        'Angela Harding supplier 2025',
        'Angela Harding supplier 2026',
        ...
        'Angela Harding transferred to Museums and Galleries',
        'Angela Harding switched to Museums and Galleries',
        'Angela Harding changed supplier to Museums and Galleries',
        'Angela Harding new supplier Museums and Galleries',
        'Angela Harding supplier change Museums and Galleries',
        'Angela Harding now sold by Museums and Galleries',
        'Angela Harding currently Museums and Galleries',
        'where is Angela Harding now',
        'where to get Angela Harding cards now',
        'Angela Harding greeting cards new supplier',
        'Angela Harding cards new distributor',
        'Angela Harding greeting cards who supplies',
        'who sells Angela Harding greeting cards',
        'who supplies Angela Harding cards',
        'Angela Harding greeting cards available from',
        'Angela Harding greeting cards stockist',
        'Angela Harding greeting cards retailer',
        
        // Angela Harding + Sales Agent + Location combinations
        'Angela Harding sales agent',
        'Angela Harding sales agent East Anglia',
        'Angela Harding sales agent Suffolk',
        'Angela Harding sales agent Norfolk',
        'Angela Harding sales agent Essex',
        'Angela Harding sales agent Cambridgeshire',
        'Angela Harding sales agent Hertfordshire',
        'Angela Harding Museums and Galleries sales agent',
        'Angela Harding Museums and Galleries sales agent East Anglia',
        'Angela Harding Art Angels sales agent',
        'Dave Langdon Angela Harding',
        'David Langdon Angela Harding',
        'Angela Harding greeting cards sales agent Dave Langdon',
        'Angela Harding greeting cards sales agent David Langdon',
        'Dave Langdon Angela Harding Museums and Galleries',
        'David Langdon Angela Harding Museums and Galleries',
    ...
    'cambridge-confectionery-company': {
      ...
      keywords: [
        ...
        'Dave Langdon Cambridge Confectionery',
        'David Langdon Cambridge Confectionery',
        'Dave Langdon Calico Cottage',
        'David Langdon Calico Cottage',
        'Dave Langdon Cambridge Confectionery Company Sales Agent',
        'David Langdon Cambridge Confectionery Company Sales Agent',
        'Dave Langdon Calico Cottage Sales Agent',
        'David Langdon Calico Cottage Sales Agent',
        'Cambridge Confectionery Company Sales Agent Dave Langdon',
        'Cambridge Confectionery Company Sales Agent David Langdon',
        ...
        'The Cambridge Confectionery Company supplier',
        'Cambridge Confectionery Company wholesale',
        'Cambridge Confectionery wholesale',
        'wholesale Cambridge Confectionery',
        'wholesale Cambridge Confectionery Company',
        'Cambridge Confectionary wholesale',
        'wholesale Cambridge Confectionary',
        'Calico Cottage wholesale',
        'wholesale Calico Cottage',
        'Calico Cottage supplier',
        ...
        'Cambridge Confectionery Company Hertfordshire',
        'Cambridge Confectionery Company Cambridgeshire',
        'Cambridge Confectionery Company Suffolk',
        'Cambridge Confectionery Company Norfolk',
        'Cambridge Confectionery Company Essex',
        'confectionery sales agent',
        'confectionery sales agent East Anglia',
        'chocolate sales agent East Anglia',
        'chocolate wholesale East Anglia',
        'wholesale chocolate East Anglia',
        'wholesale confectionery East Anglia',
        'wholesale confectionery supplier',
        'trade confectionery supplier',
        'retail confectionery supplier',
        'gift confectionery supplier',
        'sweet treats supplier',
        'East Anglia confectionery agent',
        'Hertfordshire confectionery agent',
        'Cambridgeshire confectionery agent',
        'Suffolk confectionery supplier',
        'Norfolk confectionery agent',
        'Essex confectionery supplier',
        'East Anglia Cambridge Confectionery agent',
        'East Anglia Calico Cottage agent'
      ]
    },
    'star-editions': {
