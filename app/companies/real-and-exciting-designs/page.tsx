...
function generateCompanyMetadata(company: typeof companies[0]): Metadata {
  const baseTitle = `Real and Exciting Designs | Contemporary Fashion-Led Cards & Gift Wrap`;
  const baseDescription = `Real and Exciting Designs produces trendy Everyday and Christmas greetings cards, foiled gift wrap and notebooks — printed in England on FSC board.`;
...
function generateStructuredData(company: typeof companies[0]) {
  ...
  return {
    ...
    'description': 'Real and Exciting Designs produces trendy Everyday and Christmas greetings cards, foiled gift wrap and notebooks — printed in England on FSC board.',
