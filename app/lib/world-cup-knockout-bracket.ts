...
const KNOCKOUT_BRACKET_TEMPLATES: readonly BracketTemplate[] = [
  ...
  },
  {
    ...
    round: 'R16',
    home: { kind: 'winner', slot: 'R32-5' },
    away: { kind: 'winner', slot: 'R32-2' },
    winnerPathLabel: 'Quarter-final · Fri 10 Jul',
  },
  {
    id: '2026-07-05-r16-3',
