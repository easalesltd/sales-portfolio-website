...
/** Sweepstake fixtures for our 28 ESPN-covered clubs (PL → NL). League matches only — cup ties excluded. NL North/South (14 clubs) add manually. Fetched 2026-07-21 via npm run english-pyramid:fetch-fixtures. */
