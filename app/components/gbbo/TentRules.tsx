...
export function TentRules() {
  const { league, update } = useLeague();

  return (
    <div className="space-y-6">
      <Card eyebrow="A reminder of tent law" title="How the tent is scored">
        ...
        <div className="mt-6 space-y-3 text-sm leading-7 text-chocolate/80">
          ...
          <p>Sides are date-locked. Week 1 cannot be changed. After each Tuesday episode finishes at 9pm, My team opens for one substitution until the next episode starts at 8pm. The site will not accept a change while the window is closed.</p>
