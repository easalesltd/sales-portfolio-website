...
export function MustBakeCallout({ week }: { week?: number }) {
  ...
  return (
    <section className="overflow-hidden rounded-[28px] border-2 border-raspberry bg-raspberry/10 p-5 sm:p-6">
      ...
      <div className="mt-4 flex flex-wrap items-center gap-4">
        {owners.map((owner) => (
          <div key={owner.id} className="flex items-center gap-3">
            <CompanionPhoto name={owner.name} photo={owner.photo} size="md" />
