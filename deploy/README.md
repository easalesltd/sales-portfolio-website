...
- NPM 8.x or later
- For **email confirmation** on “Request an Agent Visit”, see **`CONFIRM_EMAIL_SIMPLE.md`** (Resend + 4 variables, no EmailJS server setup) or `.env.example` for advanced EmailJS options.
